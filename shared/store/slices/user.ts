...
// export const userUpdate = createAsyncThunk('user/update', async (user: any) => {
...
export const userSignupMultiPart = createAsyncThunk('user/signup_multipart', async (user: any) => {
...
export const userResendEmailVerficatoin = createAsyncThunk('user/ResendEmailVerification', async (data: any) => {
	const response = await userService.resendVerificationEmail(data);
	return response;
});
export const userForgottenPassword = createAsyncThunk('user/forgottenPassword', async (data: any) => {
	const response = await userService.forgottenPassword(data);
	return response;
});
export const userPasswordReset = createAsyncThunk('user/passwordReset', async (data: any) => {
